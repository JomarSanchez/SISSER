<div class="container-fluid">
			<div class="page-header">
			  <h1 class="text-titles"><i class="zmdi zmdi-male-alt zmdi-hc-fw"></i> Usuarios <small>PARTICIPANTES</small></h1>
			</div>
	 ...
	 <ul class="breadcrumb breadcrumb-tabs">
		...
		<!-- Panel listado de PARTICIPANTES -->
		<div class="container-fluid">
			<div class="panel panel-success">
				<div class="panel-heading">
					<h3 class="panel-title"><i class="zmdi zmdi-format-list-bulleted"></i> &nbsp; LISTA DE PARTICIPANTES</h3>
				</div>
