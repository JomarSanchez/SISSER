				    		...
				    		<div class="container-fluid">
				    			<div class="row">
				    				...
				    				<div class="col-xs-12 col-sm-6">
										...
										<div class="radio radio-primary">
											<label>
												<input type="radio" name="optionsPrivilegio" id="optionsRadios1" value="<?php echo $loginCon->encryption(1);?>">
												<i class="zmdi zmdi-star"></i> &nbsp; Nivel 1
											</label>
										</div>
										 <?php
											 endif;
											 if($_SESSION['privilegio_ser'] <= 2 ):
										 ?>
										<div class="radio radio-primary">
											<label>
												<input type="radio" name="optionsPrivilegio" id="optionsRadios2" value="<?php echo $loginCon->encryption(2);?>">
										...
										<div class="radio radio-primary">
											<label>
												<input type="radio" name="optionsPrivilegio" id="optionsRadios3" value="<?php echo $loginCon->encryption(3);?>" checked="">
