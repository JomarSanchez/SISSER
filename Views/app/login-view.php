 <div class="full-box login-container cover">
     <form method="POST" autocomplete="off" class="logInForm">
         ...
         <div class="form-group label-floating">
             ...
             <input class="form-control login-color" id="UserName" name="usuario" type="text" required="">
             <p class="help-block">Escribe tú nombre de usuario</p>
         </div>
         <div class="form-group label-floating">
             <label class="control-label" for="UserPass">Contraseña</label>
             <input class="form-control login-color" id="UserPass" name="clave" type="password" required="">
